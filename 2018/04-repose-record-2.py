...
def strategy_2(events, n):
    ...
    for i in range(n):
        ...
        if max_intersection > max_max_intersection:
            max_max_intersection = max_intersection
            max_id = i
...
def strategy_2_solution(data):

    guards, events = parse_data(data)

    guard_ind, m = strategy_2(events, len(guards))
...
class TestMethods(unittest.TestCase):
    ...
    def test_0(self):
        ...
        self.assertEqual(strategy_2_solution(data), 4455)
